...
export function SwipeView() {
  ...
  if (loading) return <div className='min-h-screen flex items-center justify-center text-sage-green animate-pulse'>Loading names...</div>;
  if (error) return <div className='min-h-screen flex items-center justify-center text-destructive'>Error: {error.message}</div>;
