...
import { X, Heart, BabyIcon } from 'lucide-react';
      ...
      <motion.div
        ...
        <div
          className={cn(
            ...
            isBoy ? 'bg-gradient-to-br from-sage-green to-transparent' : 'bg-gradient-to-br from-warm-clay to-transparent',
          )}
        />
        ...
        <div className='flex-1 flex flex-col items-center justify-center p-8 z-20'>
          ...
          <h1 className='text-6xl font-heading text-charcoal mb-2 text-center tracking-tight'>{name.name}</h1>

          <div className='mt-12 text-muted-foreground/40 text-sm font-medium tracking-widest uppercase'>{name.originCountry}</div>
        </div>
