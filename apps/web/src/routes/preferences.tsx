...
function PreferencesView() {
  ...
  if (loading || !formData) return <div className='text-center py-20 animate-pulse text-sage-green'>Loading preferences...</div>;
      ...
      <div className='space-y-12'>
        ...
        <section>
          ...
          <input
            ...
            onChange={(e) => setFormData({ ...formData, maxCharacters: parseInt(e.target.value) })}
