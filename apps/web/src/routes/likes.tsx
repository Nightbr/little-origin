...
function LikesList() {
  ...
  if (loading) return <div className='text-center py-20 animate-pulse text-sage-green'>Loading your favorites...</div>;
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
      {names.map((name: any) => (
        <div key={name.id} className='p-6 bg-white rounded-2xl border border-border shadow-nurture transition-all hover:scale-[1.02]'>
